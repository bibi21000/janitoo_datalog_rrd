...
logger = logging.getLogger('janitoo.datalog')
...
class DatalogServer(JNTServer):
    ...
    def _get_egg_path(self):
        ...
        """
        try:
            _dist = get_distribution('janitoo_datalog_rrd')
            return _dist.__file__
        except AttributeError:
            return os.path.join("/opt/janitoo/src",'janitoo_datalog_rrd/config')
